...
{
	name = "Build Wars (v3)", 
	author = "Twisted|Panda, DR.API CS:GO Version", 
...
public OnPluginStart()
{
	...
	g_hCvar[CVAR_ACCESS_BASE] = CreateConVar("sm_buildwars_access_base", "7", "Controls access to the base feature, if it is enabled. Add values together for multiple group access. (0 = Disabled, 1 = Normal, 2 = Supporters, 4 = Admins)", FCVAR_NONE, true, 0.0, true, 7.0);
...
Bool_ClearClientProps(client, bool:deleteex = true, bool:clearex = false)
{
	new _iDeleted;
	if(deleteex)
	{
